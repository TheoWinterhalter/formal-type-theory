...
\end{equation*}
%
By induction hypothesis on the right premise we obtain $\istype{\G}{\A}$ and
$\istype{\G}{\B}$. Now, using $\rl{ty-ctx-conv}$ with the left premise and the
$\istype{\G}{\B}$, we get $\istype{\D}{\B}$. From this, we conclude
$\isctx{\ctxextend{\G}{\A}}$ and $\isctx{\ctxextend{\D}{\B}}$ by applying
$\rl{ctx-extend}$.
