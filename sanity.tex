...
$.
\meta{We need yet another rule to conclude.}
...
%
\meta{How we get the rest is unclear if we don't want to invert on
$\istype{\G}{\Id{\A}{\uu}{\vv}}$}.
...
$\isctx{\G}$ and $\istype{\G}{\Prod{\A} \B}$ and
$\isterm{\G}{\uu}{\Prod{\A} \B}$.
By induction hypothesis on the right premise we get the last conclusion:
