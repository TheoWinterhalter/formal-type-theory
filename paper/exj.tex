...
%
\meta{Problem with how $\sbs$ should go through the terms inside Id-types here
as well.}
\meta{TODO}
...
%
\meta{For the right-hand side we need to be able to type  $\C_2$ in the context
with only $2$s as subscript.}
\meta{TODO}
