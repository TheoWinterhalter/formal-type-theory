...
$\isterm{\G}
  ...
  {\subst{\subst{\A}{\sbzero{\D}{\Unit}{\uu}}}{\sbs}}
$.
% Similarly, several applications of {\rlTermSubst} and an application of
% {\rlTySubst} (up to {\rlSubstShift}) followed by {\rlTermLet} yield
% $\isterm{\G}
%   {\subst{(\ulet{\A}{\uu} \vv)}{\sbs}}
%   {\subst{\subst{\A}{\sbzero{\D}{\Unit}{\uu}}}{\sbs}}
% $.
...
$.
\meta{I see how to conclude but I give up...}
