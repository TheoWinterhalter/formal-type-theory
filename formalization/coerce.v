...
Inductive type_coercion : Type :=
  | type_id : type_coercion
  | type_cong_prod : type_coercion ->
                     type_coercion ->
                     type_coercion
  | type_cong_id : type_coercion ->
                   term_coercion ->
                   term_coercion ->
                   type_coercion
...
Fixpoint inv_type_coe (crt : type_coercion) : type_coercion :=
  match crt with
  | type_id => type_id
...
Fixpoint act_term_type (crc : type_coercion) (u : term) : term :=
  match crc with
  | type_id => u
...
Definition act_term (crc : context_coercion) (crt : type_coercion) (u : term) : term :=
...
Inductive istypecoe : type_coercion -> type -> type -> Type :=
  | istype_id : forall {G A B}, eitt.eqtype G A B -> istypecoe type_id A B.
