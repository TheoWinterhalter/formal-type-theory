...
Proof.
  ...
  { destruct P ; doConfig.
    ...
    - {
     ...
     (* SubstCtxConv *)
     - {
         capply (@SubstCtxConv _ _ _ G1 G2 D1 D2).
         - now apply sane_issubst.
  ...
  { destruct P.
    ...
    (* SubstTrans *)
    - { capply (@SubstTrans _ _ _ G D sb1 sb2 sb3).
        - now apply sane_eqsubst.
        - now apply sane_eqsubst.
    ...
    (* CongSubstComp *)
    - { capply (@CongSubstComp _ _ _ G D E).
        - now apply sane_eqsubst.
        - now apply sane_eqsubst.
        - now apply (@ptt_sane_eqsubst sbs1 sbs2 G D), sane_eqsubst.
        - now apply (@ptt_sane_eqsubst sbs1 sbs2 G D), sane_eqsubst.
    ...
    (* EqSubstCtxConv *)
    - { capply (@EqSubstCtxConv _ _ _ G1 G2 D1 D2).
        - now apply sane_eqsubst.
        - now apply sane_eqctx.
        - now apply sane_eqctx.
    ...
    (* CompAssoc *)
    - { capply (@CompAssoc _ _ _ G D E F).
        - now apply sane_issubst.
        - now apply sane_issubst.
        - now apply sane_issubst.
        - now apply (@ptt_sane_issubst sbs G D), sane_issubst.
  ...
  { destruct P.
    ...
    (* EqTyTrans *)
    { capply (@EqTyTrans _ _ _ G A B C).
      - now apply sane_eqtype.
      - now apply sane_eqtype.
      - now apply (ptt_sane_eqtype G A B), sane_eqtype.
      - now apply (ptt_sane_eqtype G A B), sane_eqtype.
    ...
    (* EqTySubstComp *)
    { capply (@EqTySubstComp _ _ _ G D E).
      - now apply sane_istype.
      - now apply sane_issubst.
      - now apply sane_issubst.
      - now apply (@ptt_sane_issubst sbs G D), sane_issubst.
    ...
    (* EqTySubstProd *)
    { capply (@EqTySubstProd _ _ _ G D).
      - now apply sane_issubst.
    ...
    (* EqTySubstEmpty *)
    { capply (@EqTySubstEmpty _ _ _ G D).
      - now apply sane_issubst.
      - now apply (@ptt_sane_issubst sbs G D), sane_issubst.
      - now apply (@ptt_sane_issubst sbs G D), sane_issubst.
    }
    ...
    (* EqTySubstUnit *)
    { capply (@EqTySubstUnit _ _ _ G D).
      - now apply sane_issubst.
      - now apply (@ptt_sane_issubst sbs G D), sane_issubst.
      - now apply (@ptt_sane_issubst sbs G D), sane_issubst.
    }
    ...
    (* EqTySubstBool *)
    { capply (@EqTySubstBool _ _ _ G D).
      - now apply sane_issubst.
      - now apply (@ptt_sane_issubst sbs G D), sane_issubst.
      - now apply (@ptt_sane_issubst sbs G D), sane_issubst.
    }
    ...
    (* EqTyExfalso *)
    { capply (@EqTyExfalso _ _ _ G A B u).
      - now apply (@ptt_sane_istype G A), sane_istype.
      - now apply sane_istype.
      - now apply sane_istype.
      - now apply sane_isterm.
  ...
  { destruct P.
    ...
    (* EqTrans *)
    - { capply (@EqTrans _ _ _ G A u v w).
        - now apply sane_eqterm.
        - now apply sane_eqterm.
        - now apply (@ptt_sane_eqterm G u v A), sane_eqterm.
        - now apply (@ptt_sane_eqterm G u v A), sane_eqterm.
    ...
    (* EqSubstComp *)
    - { capply (@EqSubstComp _ _ _ G D E A u sbs sbt).
        - now apply sane_isterm.
        - now apply sane_issubst.
        - now apply sane_issubst.
        - now apply (@ptt_sane_issubst sbs G D), sane_issubst.
    ...
    (* EqSubstShiftZero *)
    - { capply (@EqSubstShiftZero _ _ _ G D).
        - now apply (@ptt_sane_issubst sbs G D), sane_issubst.
        - now apply (@ptt_sane_issubst sbs G D), sane_issubst.
        - now apply sane_issubst.
        - now apply sane_istype.
    ...
    (* EqSubstShiftSucc *)
    - { capply (@EqSubstShiftSucc _ _ _ G D).
        - now apply (@ptt_sane_issubst sbs G D), sane_issubst.
        - now apply (@ptt_sane_issubst sbs G D), sane_issubst.
    ...
    (* EqSubstExfalso *)
    - { capply (@EqSubstExfalso _ _ _ G D).
        - now apply (@ptt_sane_issubst sbs G D), sane_issubst.
        - now apply (@ptt_sane_issubst sbs G D), sane_issubst.
        - now apply sane_istype.
        - now apply sane_isterm.
    ...
    (* EqTermExfalso *)
    - { capply (@EqTermExfalso _ _ _ G A u v w).
        - now apply (ptt_sane_isterm G u A), sane_isterm.
        - now apply (ptt_sane_isterm G u A), sane_isterm.
        - now apply sane_isterm.
        - now apply sane_isterm.
    ...
    (* CongTermSubst *)
    - { capply (@CongTermSubst _ _ _ G D).
        - now apply sane_eqsubst.
        - now apply sane_eqterm.
        - now apply (@ptt_sane_eqsubst sbs sbt G D), sane_eqsubst.
        - now apply (@ptt_sane_eqsubst sbs sbt G D), sane_eqsubst.
