...
\newcommand{\rlSubstCompose}{\referTo{subst-compose}{rul:subst-compose}}
\newcommand{\showSubstCompose}{%
  \infer[\rulename{subst-compose}] % SubstCompose
  {\issubst{\sbs}{\G}{\D} \\
    \issubst{\sbt}{\D}{\E}
  }
...
\newcommand{\rlSubstExtend}{\referTo{subst-extend}{rul:subst-extend}}
\newcommand{\showSubstExtend}{%
  \infer[\rulename{subst-extend}] % SubstExtend
  {\issubst{\sbs}{\G}{\D} \\
    \istype{\D}{\A} \\
...
\newcommand{\rlTermVar}{\referTo{term-var}{rul:term-var}}
\newcommand{\showTermVar}{%
  \infer[\rulename{term-var}] % TermVar
  {
    \istype{\G}{\A}
  }
  {\isterm
...
\newcommand{\rlTermVarSkip}{\referTo{term-var-skip}{rul:term-var-skip}}
\newcommand{\showTermVarSkip}{%
  \infer[\rulename{term-var-skip}] % TermVarSkip
  {\isterm{\G}{\var{k}}{\A} \\
    \istype{\G}{\B}
  }
  {\isterm
...
%   \infer[\rulename{eq-ty-subst-identity}] % EqTySubstId
%   {\istype{\G}{\A}}
%   {\eqtype{\G}
%     {\subst{\A}{\sbid{\G}}}
%     {\A}
...
\newcommand{\rlEqTySubstCompose}{\referTo{eq-ty-subst-compose}{rul:eq-ty-subst-compose}}
\newcommand{\showEqTySubstCompose}{%
  \infer[\rulename{eq-ty-subst-compose}] % EqTySubstCompose
  {\issubst{\sbs}{\G}{\D} \\
    \issubst{\sbt}{\D}{\E} \\
    \istype{\E}{\A}
  }
...
\newcommand{\rlEqSubstId}{\referTo{eq-subst-id}{rul:eq-subst-id}}
\newcommand{\showEqSubstId}{%
  \infer[\rulename{eq-subst-id}] % EqSubstId
  {\isterm{\G}{\uu}{\A}}
  {\eqterm{\G}
    {\subst{\uu}{\sbid{\G}}}
    {\uu}
...
\newcommand{\rlEqSubstCompose}{\referTo{eq-subst-compose}{rul:eq-subst-compose}}
\newcommand{\showEqSubstCompose}{%
  \infer[\rulename{eq-subst-compose}] % EqSubstCompose
  {\issubst{\sbs}{\G}{\D} \\
    \issubst{\sbt}{\D}{\E} \\
    \isterm{\E}{\uu}{\A}
  }
...
\newcommand{\rlEqSubstExtendZero}{\referTo{eq-subst-extend-zero}{rul:eq-subst-extend-zero}}
\newcommand{\showEqSubstExtendZero}{%
  \infer[\rulename{eq-subst-extend-zero}] % EqSubstExtendZero
  {\issubst{\sbs}{\G}{\D} \\
    \istype{\D}{\A} \\
    \isterm{\G}{\uu}{\subst{\A}{\sbs}}
  }
...
\newcommand{\rlEqSubstExtendSucc}{\referTo{eq-subst-extend-succ}{rul:eq-subst-extend-succ}}
\newcommand{\showEqSubstExtendSucc}{%
  \infer[\rulename{eq-subst-extend-succ}] % EqSubstExtendSucc
  {\issubst{\sbs}{\G}{\D} \\
    \isterm{\D}{\var{k}}{\A} \\
