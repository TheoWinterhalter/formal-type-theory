...
\begin{align*}
  ...
  \text{Substitution $\sbs$, $\sbt$}
    \bnf   {}& \sbid{\G}                && \text{identity substitution $\G \to \G$ \meta{GO AWAY}} \\
    \bnfor {}& \sbcomp{\sbs}{\sbt}      && \text{composition of substitutions \meta{GO AWAY}} \\
    \bnfor {}& \sbextend{\sbs}{\A}{\uu} && \text{substitution $\sbs$ extended with $\uu$ of type $\subst{\A}{\sbs}$ \meta{GO AWAY}} \\
...
\begin{mathpar}
  {\label{rul:subst-id} \showSubstId \meta{GO AWAY}}

  {\label{rul:subst-compose} \showSubstCompose \meta{GO AWAY}}

  {\label{rul:subst-extend} \showSubstExtend \meta{GO AWAY}}
...
\begin{mathpar}
  % XXX We used to have here the other EqTySubstId

  {\label{rul:eq-ty-subst-compose} \showEqTySubstCompose \meta{GO AWAY}}
...
\begin{mathpar}
  {\label{rul:eq-subst-id} \showEqSubstId \meta{GO AWAY}}

  {\label{rul:eq-subst-compose} \showEqSubstCompose \meta{GO AWAY}}

  {\label{rul:eq-subst-extend-zero} \showEqSubstExtendZero \meta{GO AWAY}}

  {\label{rul:eq-subst-extend-succ} \showEqSubstExtendSucc \meta{GO AWAY}}
\end{mathpar}
