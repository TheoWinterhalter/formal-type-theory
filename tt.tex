...
\begin{mathpar}
  ...
  {\isterm
     ...
     {\subst{\T_2}{\sbextend{\sbunit{\G}}{\x}{\e_2}}}
  }
\end{mathpar}
...
\begin{mathpar}
  \infer[\rulename{eq-subst-var-unit}]
  {\isterm{\G}{\x}{\T}}
  {\eqterm{\G}
     {\subst{\x}{\sbunit{\G}}}
     {\x}
  ...
  \infer[\rulename{eq-subst-var-extend}]
  {\issubst{\sbs}{\G}{\D} \\
   \istype{\D}{\T} \\
   \isterm{\G}{\e}{\subst{\T}{\sbs}} \\
   \x \not\in \ctxdom{\D}
  ...
  {\eqterm{\G}
     {\subst{\x}{\sbextend{\sbs}{\x}{\e}}}
     {\e}
     {\subst{\T}{\sbs}}
  }

  \infer[\rulename{eq-subst-var-skip}]
  {\issubst{\sbs}{\G}{\D} \\
   \isterm{\D}{\y}{\T_1} \\
   \istype{\D}{\T_2} \\
   \isterm{\G}{\e}{\subst{\T_2}{\sbs}} \\
   \x \not\in \ctxdom{\D}
  }
  {\eqterm{\G}
     {\subst{\y}{\sbextend{\sbs}{\x}{\e}}}
     {\subst{\y}{\sbs}}
     {\subst{\T_1}{\sbs}}
  }

  \infer[\rulename{eq-subst-abs}]
  {\issubst{\sbs}{\G}{\D} \\
   \isterm{\ctxextend{\D}{\x}{\T_1}}{\e}{\T_2} \\
   \y \not\in \ctxdom{\G}
  }
  {\eqterm{\G}
    {\subst{(\lam{\x}{\T_1}{\T_2} \e)}{\sbs}}
    {(\lam{\y}{(\subst{\T_1}{\sbs})}{(\subst{\T_2}{\sbextend{\sbs}{\x}{\y}})} \subst{\e}{\sbextend{\sbs}{\x}{\y}})}
    {\Prod{\y}{\subst{\T_1}{\sbs}}{\subst{\T_2}{\sbextend{\sbs}{\x}{\y}}}}
  }

  \infer[\rulename{eq-subst-app}]
  {\issubst{\sbs}{\G}{\D} \\
   \y \not\in \ctxdom{\G} \\\\
   \istype{\ctxextend{\D}{\x}{\T_1}}{\T_2} \\
...
\infer[\rulename{prod-beta}]
  ...
  {\eqterm{\G}{\bigl(\app{(\lam{\x}{\T_1}{\T_2}{\e_1})}{\x}{\U_1}{\U_2}{\e_2}\bigr)}
              {\subst{\e_1}{\sbextend{\sbunit{\G}}{\x}{\e_2}}}
              {\subst{\U_2}{\sbextend{\sbunit{\G}}{\x}{\e_2}}}}
