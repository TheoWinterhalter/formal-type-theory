...
\begin{align*}
  ...
  \text{Substitution $\sbs$}
    ...
    \bnfor {}& \sbextend{\sbs}{\x}{\A}{\uu} && \text{substitution $\sbs$ extended with $\x \mapsto \uu$}
\end{align*}
...
\begin{align*}
  ...
  &
  \sbid{(\ctxextend{\G}{\x}{\A})} &= (\sbextend{\sbid{\G}}{\x}{\A}{\x}).
\end{align*}
%
...
\begin{mathpar}
  ...
  {\eqtype{\G}
   ...
   {\Prod{\y}{\subst{\A}{\sbs}}{\subst{\B}{\sbextend{\sbs}{\x}{\A}{\y}}}}
  }
